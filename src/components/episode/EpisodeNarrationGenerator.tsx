  ...
  const handleGenerateNarration = async () => {
    ...
    try {
      ...
      if (storageUrl.startsWith('gs://')) {
        console.warn('⚠️ Received gs:// URI from uploadEpisodeNarration:', storageUrl);
        ...
        if (!validUrl) {
          throw new Error('Invalid Firebase Storage URL received from uploadEpisodeNarration');
        }
      }
