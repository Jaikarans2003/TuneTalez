...
import { extractParagraphMetadata, generateTTSAudio, fetchBackgroundMusic, mixAudioWithBackground, uploadAudioToFirebase } from '@/utils/nodeAudioNarrationService';
...
export async function POST(request: NextRequest) {
  try {
    ...
    await generateTTSAudio(body.text, narrationPath, body.options || {});
    ...
    await mixAudioWithBackground(narrationPath, backgroundMusicPath, mixedPath, body.options || {});
