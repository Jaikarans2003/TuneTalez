        ...
        <div className="w-full px-4 py-20 md:py-32 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-block mb-4 px-6 py-2 bg-gradient-to-r from-primary/20 to-orange/20 rounded-full backdrop-blur-sm animate-fade-in">
              <span className="text-white/90 font-medium">Your Digital Bookshelf</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-gray-300 animate-slide-up">
              <span className="text-primary">Tune</span>Talez
            </h1>
            <p className="text-xl md:text-2xl mb-10 text-gray-300 max-w-3xl mx-auto leading-relaxed animate-slide-up stagger-1">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 animate-slide-up stagger-2">
              <button className="bg-gradient-to-r from-primary to-primary-dark text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-primary/30 hover:scale-105 transform">
                Explore Books
              </button>
              <button className="bg-transparent border-2 border-white/30 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:bg-white/10 hover:border-white/50">
                Upload Content
              </button>
            </div>
          </div>
            ...
            <section className="mb-16 py-16">
              <div className="flex flex-col md:flex-row justify-between items-center mb-12 animate-fade-in">
                <div className="mb-6 md:mb-0 animate-slide-up">
                  ...
                  <h2 className="text-4xl font-bold text-white flex items-center">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300">Explore Our Books</span>
                  </h2>
                </div>
              ...
              {books.length === 0 ? (
                <div className="text-center py-16 bg-gradient-to-br from-[#1F1F1F] to-[#252525] rounded-2xl border border-gray-800 shadow-xl animate-fade-in">
                  ...
                  <button className="bg-primary/20 hover:bg-primary/30 text-primary-light font-medium py-2 px-6 rounded-lg transition-all duration-300 animate-slide-up stagger-3 hover:scale-105">
                ...
                <div className="text-center py-16 bg-gradient-to-br from-[#1F1F1F] to-[#252525] rounded-2xl border border-gray-800 shadow-xl animate-fade-in">
                  ...
                  <button onClick={() => setSearchTerm('')} className="bg-primary/20 hover:bg-primary/30 text-primary-light font-medium py-2 px-6 rounded-lg transition-all duration-300 animate-slide-up stagger-3 hover:scale-105">
                    Clear Search
                  </button>
                </div>
              ) : (
              ...
              <div className="relative z-10">
                <div className="text-center mb-12 animate-fade-in">
                  <div className="flex items-center justify-center mb-2">
                    <div className="w-10 h-1 bg-gradient-to-r from-primary to-orange rounded mr-3"></div>
                    <span className="text-primary-light uppercase tracking-wider text-sm font-semibold">What Readers Say</span>
