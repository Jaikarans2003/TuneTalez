 ...
 * @param storagePath Path in Firebase Storage to upload toSS
...
export async function uploadAudioToFirebase(filePath: string, storagePath: string): Promise<string> {
  try {
    console.log(`Uploading audio file to Firebase Storage: ${filePath} -> ${storagePath}`);
    ...
    console.log(`Uploaded audio file to Firebase Storage: ${snapshot.metadata.fullPath}`);
